...
// RunTestsForImplicitSet_Union runs a test suite to check correct implementation of the Union method on
// [pkg/github.com/frederik-jatzkowski/cantor.ImplicitSet].
func RunTestsForImplicitSet_Union(t *testing.T, constructor Constructor[byte, cantor.ImplicitSet[byte]]) {
