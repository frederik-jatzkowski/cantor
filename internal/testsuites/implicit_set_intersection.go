...
// RunTestsForImplicitSet_Intersection runs a test suite to check correct implementation of the Intersection method on
// [pkg/github.com/frederik-jatzkowski/cantor.ImplicitSet].
func RunTestsForImplicitSet_Intersection(t *testing.T, constructor Constructor[byte, cantor.ImplicitSet[byte]]) {
