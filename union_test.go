...
func Test_union_Union(t *testing.T) {
	...
	cantor.NewHashSet(1, 2, 3, 4, 5, 6).Iterator()(func(element int) (next bool) {
...
func Test_union_Intersection(t *testing.T) {
	...
	cantor.NewHashSet(3, 4).Iterator()(func(element int) (next bool) {
...
func Test_union_IntoHashSet(t *testing.T) {
	set := cantor.NewHashSet(1, 2).Union(cantor.NewHashSet(3, 4))
